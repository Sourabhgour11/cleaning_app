...
class ModernBottomBar extends StatefulWidget {
  const ModernBottomBar({Key? key, this.onTabChanged, this.currentIndex = 0})
      : super(key: key);
...
class LinkedInBottomBar extends StatefulWidget {
  const LinkedInBottomBar({Key? key, this.onTabChanged, this.currentIndex = 0})
      : super(key: key);
...
class CustomBottomBar extends StatefulWidget {
  const CustomBottomBar({Key? key, this.onTabChanged, this.currentIndex = 0})
      : super(key: key);
  final Function(int)? onTabChanged;
  final int currentIndex;
