...
class PartnerModernBottomBar extends StatefulWidget {
  const PartnerModernBottomBar({
    super.key,
    this.onTabChanged,
    this.currentIndex = 0,
  });
  ...
  @override
  _PartnerModernBottomBarState createState() => _PartnerModernBottomBarState();
}

class _PartnerModernBottomBarState extends State<PartnerModernBottomBar>
    with SingleTickerProviderStateMixin {
  late AnimationController _animationController;

  final List<Color> colors = [AppColours.appColor, Colors.blue, Colors.purple];

  final List<String> labels = ['Home', 'Announcements', 'Profile'];
