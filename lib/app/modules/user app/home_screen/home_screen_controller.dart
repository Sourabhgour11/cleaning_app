...
class HomeScreenController extends GetxController {
  ...
  final List<Map<String, dynamic>> salonAndSpa = [
    ...
    {'name': 'Nail Extensions', 'image': "lib/assets/images/nail_extension.jpg"},
  ...
  final List<Map<String, dynamic>> handyMan = [
    {'name': "Handyman & Maintenance", 'image': "lib/assets/images/handyman.jpg"},
    {'name': "Home Painting", 'image': "lib/assets/images/home_painting.jpeg"},
    {'name': "Water Tank Cleaning", 'image': "lib/assets/images/water_tank_cleaning.jpg"},
  ];

  final List<Map<String, dynamic>> healthCareAtHome = [
    {'name': "Lab Tests at Home", 'image': "lib/assets/images/lab_test_at_home.jpg"},
    {'name': "IV Therapy at Home", 'image': "lib/assets/images/iv_therapy_at_home.jpeg"},
    {'name': "Doctor Consultations", 'image': "lib/assets/images/doctor_consultations.jpg"},
    {'name': "Flu Vaccine at Home", 'image': "lib/assets/images/flu_vaccine.jpeg"},
    {'name': 'Nurse Care at Home', 'image': "lib/assets/images/nurse_care_at_home.jpg"},
    {'name': 'Psychotherapy at Home', 'image': "lib/assets/images/physiotherary_at_home.jpg"},
  ];
