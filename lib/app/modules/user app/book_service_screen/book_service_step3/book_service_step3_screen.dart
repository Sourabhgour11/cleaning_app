...
class BookServiceStep3Screen extends StatelessWidget {
   ...
   final BookServiceStep3ScreenController step3Controller = Get.put(BookServiceStep3ScreenController());
  ...
  Widget _buildPaymentMethodCard(BookServiceStep3ScreenController controller) {
  ...
  Widget _buildCardDetailsSection(BookServiceStep3ScreenController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Card Number
  ...
  Widget _buildVoucherCodeSection(BookServiceStep3ScreenController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
